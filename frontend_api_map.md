...
| TeacherApplyList              | /api/teacher-applications | GET    | �ҵĽ�ʦ�����б�         | Query: status?, page?, size?     | Yes  | YES    | Response includes reviewComment when reviewed |
...
| AdminTeacherApplications | /api/admin/teacher-applications/{id}/review | PUT | ���ͨ��/�ܾ�    | Route: id; Body: { approved, reviewComment? } | Yes  | YES    | reviewComment applies to approve/reject; visible in teacher list |
